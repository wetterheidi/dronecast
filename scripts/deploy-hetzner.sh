#!/usr/bin/env bash
#
# Deployt droneforecast nach https://dronecast.wetterheidi.de
#
...
# - Synchronisiert dist/ nach /apps/dronecast auf dem Server
#
# Pfoertner: Der Vhost meldet sich als tool=dronecast. Damit jemand
...
DOMAIN="dronecast.wetterheidi.de"
REMOTE_DIR="/apps/dronecast"
